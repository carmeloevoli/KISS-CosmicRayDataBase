...
void run() {
    ...
    {
        KISS::CRDB data(KISS::cream, KISS::totalEnergy, KISS::H, KISS::Laff2_7);
        data.setDescription("III");
        data.setDOI("10.3847/1538-4357/aa68e4");
        data.setADSbibcode("2017ApJ...839....5Y");
        data.setComments("Converted from original data in Ekn");
        data.run();
    }
    {
    ...
    {
        KISS::CRDB data(KISS::cream, KISS::totalEnergy, KISS::He, KISS::Laff2_7);
        data.setDescription("III");
        data.setDOI("10.3847/1538-4357/aa68e4");
        data.setADSbibcode("2017ApJ...839....5Y");
        data.setComments("Converted from original data in Ekn");
    ...
    {
        KISS::CRDB data(KISS::cream, KISS::totalEnergy, KISS::C, KISS::Laff2_7);
        data.setDescription("II");
        data.setDOI("10.1088/0004-637X/707/1/593");
        data.setADSbibcode("2009ApJ...707..593A");
        data.setComments("Converted from original data in Ekn");
    ...
    {
        KISS::CRDB data(KISS::cream, KISS::totalEnergy, KISS::O, KISS::Laff2_7);
        data.setDescription("II");
        data.setDOI("10.1088/0004-637X/707/1/593");
        data.setADSbibcode("2009ApJ...707..593A");
        data.setComments("Converted from original data in Ekn");
    ...
    {
        KISS::CRDB data(KISS::cream, KISS::totalEnergy, KISS::Ne, KISS::Laff2_7);
        data.setDescription("II");
        data.setDOI("10.1088/0004-637X/707/1/593");
        data.setADSbibcode("2009ApJ...707..593A");
        data.setComments("Converted from original data in Ekn");
    ...
    {
        KISS::CRDB data(KISS::cream, KISS::totalEnergy, KISS::Mg, KISS::Laff2_7);
        data.setDescription("II");
        data.setDOI("10.1088/0004-637X/707/1/593");
        data.setADSbibcode("2009ApJ...707..593A");
        data.setComments("Converted from original data in Ekn");
    ...
    {
        KISS::CRDB data(KISS::cream, KISS::totalEnergy, KISS::Si, KISS::Laff2_7);
        data.setDescription("II");
        data.setDOI("10.1088/0004-637X/707/1/593");
        data.setADSbibcode("2009ApJ...707..593A");
        data.setComments("Converted from original data in Ekn");
    ...
    {
        KISS::CRDB data(KISS::cream, KISS::totalEnergy, KISS::Fe, KISS::Laff2_7);
        data.setDescription("II");
        data.setDOI("10.1088/0004-637X/707/1/593");
        data.setADSbibcode("2009ApJ...707..593A");
        data.setComments("Converted from original data in Ekn");
