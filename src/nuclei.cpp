...
void TUNKA() {
    {
        CRDB dataSet("TUNKA-133");
        dataSet.set_doi("10.1016/j.nima.2013.09.018");
        dataSet.set_ADSbibcode("2014NIMPA.756...94P ");
        dataSet.set_mode("geometrical");
        dataSet.set_xUnits("total energy");
        dataSet.set_yType("H");
        dataSet.set_comments("QGSJet01");
        dataSet.loadDataset("source/nuclei/CRDB_H_TUNKA-133_Etot.txt");
        dataSet.save("output/H_TUNKA-133_Etot.txt");
    }
    {
        CRDB dataSet("TUNKA-133");
        dataSet.set_doi("10.1016/j.nima.2013.09.018");
        ...
        dataSet.set_yType("He");
        dataSet.set_comments("QGSJet01");
        dataSet.loadDataset("source/nuclei/CRDB_He_TUNKA-133_Etot.txt");
        dataSet.save("output/He_TUNKA-133_Etot.txt");
    }
}
